                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-footer-widget instafeed">
                            ...
                            <ul class="list instafeed d-flex flex-wrap">
                                <li><img src="public/img/instagram/Image-01.jpg" alt=""></li>
                                <li><img src="public/img/instagram/Image-02.jpg" alt=""></li>
                                <li><img src="public/img/instagram/Image-03.jpg" alt=""></li>
                                <li><img src="public/img/instagram/Image-04.jpg" alt=""></li>
                                <li><img src="public/img/instagram/Image-05.jpg" alt=""></li>
                                <li><img src="public/img/instagram/Image-06.jpg" alt=""></li>
                                <li><img src="public/img/instagram/Image-07.jpg" alt=""></li>
                                <li><img src="public/img/instagram/Image-08.jpg" alt=""></li>
                            </ul>
                        </div>
                    </div>	
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
        ...
        <script src="public/vendors/flipclock/timer.js"></script>
