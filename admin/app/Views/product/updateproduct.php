    ...
    <div class="wrap clearfix">
        ...
        <div id="content" class="fl-right">
            <div class="section" id="title-page">
                <div class="clearfix">
                    <h3 id="index" class="fl-left">UPDATE PRODUCT</h3>
                </div>
            ...
            <div class="section" id="detail-page">
                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input name = "price" type="number" class="form-control" id="Price" placeholder="price *" value = "<?php echo $product["Price"] ?>">
                    </div>
                    ...
                    <button type="button" name="btn-submit" item = <?php echo $_GET["product"] ?> id="btn-update">Update Product</button>        
                </form>
                </div>
            </div>
        </div>
